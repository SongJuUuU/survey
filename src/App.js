...
function App() {
  ...
  const questions = {
    q1: [
      ...
      "2. 나는 선택 가능한 전공들 중에서 원하는 전공을 택할 수 있다.",
      "3. 나의 진로 목표에 대해서 향후 5년간의 계획을 세울 수 있디.",
      "4. 내가 선택한 전공과 관련해서 학업적인 어려움이 있을 경우, 그 문제를 해결할 수 있다.",
      "5. 나는 나의 능력을 정확히 알 수 있다.",
      "6. 나는 마음에 두고 있는 직업들 가운데 한 가지 직업을 선택할 수 있다.",
      "7. 내가 선택한 전공을 성공적으로 완수하기 위해 필요한 방법들을 계획 할 수 있다.",
      "8. 나는 힘든 상황에서도 좌절하지 않고 목표하는 전공이나 진로를 위해서 끝까지 노력할 수 있다.",
      "9. 나는 나에게 어떤 직업이 잘 맞는지 알 수 있다.",
      "10. 나는 내가 관심 있는 직업의 향후 10년간의 고용 동향을 알아낼 수 있다.",
      "11. 나는 내가 원하는 라이프 스타일에 맞는 진로를 결정할 수 있다.",
      "12. 나는 이력서를 잘 준비할 수 있다."
    ],
    q2: [
      "13. 나는 처음에 선택한 전공이 만족스럽지 않다면 전공을 바꿀 수 있다.",
      "14. 나는 내가 직업 선택에 있어서 가장 중요하게 여기는 것이 무엇인지 알 수 있다.",
      "15. 나는 내가 원하는 직업에 종사하는 사람들의 평균 연봉을 알아낼 수 있다.",
      "16. 나는 진로를 결정한 후 그것이 잘한 것인지 못한 것인지에 대해 염려하지 않을 수 있다.",
      "17. 나는 선택한 직업이 만족스럽지 않으면 다른 직업으로 바꿀 수 있다.",
      "18. 진로 목표를 달성하기 위해 내가 어떤 것은 희생할 수 있고 어떤 것은 희생할 수 없는지 구분하여 알 수 있다.",
      "19. 나는 내가 관심 있는 직업에 대해서 알아보기 위해 그 분야에 종사하고 있는 사람들과 이야기해 볼 수 있다.",
      "20. 나의 흥미와 적성에맞는 전공이나 진로를 선택할 수 있다.",
      "21. 나는 내가 원하는 직업과 관련 있는 고용주나 회사, 혹은 기관을 찾아낼 수 있다.",
      "22. 나는 내가 원하는 라이프 스타일이 무엇인지 정확히 알 수 있다.",
      "23. 나는 대학원이나 전문 교육기관에 대한 정보를 찾을 수 있다.",
      "24. 나는 취업을 위한 면접을 성공적으로 준비할 수 있다.",
      "25. 나는 처음의 선택이 불가능할 경우를 대비해 합리적인 대안이나 다른 진로를 알아낼 수 있다."
    ]
  };

  const finalQuestions = {
    q3: [
      "1. 나는 지난 세 달 동안 친구들과 나의 적성 및 앞으로의 취업 등에 대해서 이야기를 나눈 적이 있다.",
      "2. 나는 지난 세 달 동안 부모님과 나의 적성 및 앞으로의 취업 등에 대해서 이야기를 나눈 적이 있다.",
      "3. 나는 지난 세 달 동안 교수님과 나의 적성 및 앞으로의 취업 등에 대해서 이야기를 나눈 적이 있다.",
      "4. 나는 지난 세 달 동안 내가 관심을 가지고 있는 직업에 관련된 책이나 팸플릿 등을 구입하거나 혹은 읽어보았다.",
      "5. 나는 지난 세 달 동안 내가 관심을 가지고 있는 직업이나 진로와 관련된 교육기관이나 혹은 교육 훈련 프로그램 등에 대한 안내 책자나 팸플릿(소책자) 등을 구입하거나 읽어본 적 있다.",
      "6. 나는 지난 세 달 동안 내가 관심을 가지고 있는 직업에 관련된 기관을 직접 방문해 보았거나 혹은 방문 계획을 세운 적이 있다.",
      "7. 나는 지난 세 달 동안 내가 관심을 가지고 있는 직업에 관련된 TV프로그램, 전시회, 설명회 등을 시청하거나 참관한 적이 있다.",
      "8. 나는 지난 세 달 동안 내가 관심을 가지고 있는 직업에 관련된 자료를 인터넷을 통해 탐색해 보았다.",
      "9. 나는 지난 세 달 동안 내가 관심을 가지고 있는 직업에 진출하기 위한 자격요건이 무엇인지 구체적으로 알아본 적이 있다.",
      "10. 나는 지난 세 달 동안 내가 관심을 가지고 있는 직업에 관련된 전문가들과 이야기를 나누어 본 적이 있다."
    ],
    q4: [
      "11. 나는 지난 세 달 동안 내가 관심을 가지고 있느 직업에 실제 종사하고 있는 사람들과 이야기를 나누어 본 적이 있다.",
      "12. 나는 지난 세 달 동안 내가 관심을 가지고 있는 직업에 관해 상담기관 등을 방문한 적이 있다.",
      "13. 나는 지난 세 달 동안 나의 적성과 흥미, 성격 등을 정확히 알아보기 위해서 검사를 받아본 적이 있다.",
      "14. 나는 관심을 가지고 있는 직업에 입문하기 위해서 그 준비에 필요한 교재, 또는 참고 서적, 또는 기타 기자재 등을 구입하였다.",
      "15. 나는 관심을 가지고 있는 직업에 입문하기 위햇 이미 구입한 교재, 또는 참고서적, 또는 기타 필요한 기자재 등을 가지고 진로 준비를 하고 있다.",
      "16. 나는 관심을 가지고 있는 직업에 입문하기 위해서, 학원에 다니거나 취업 준비 동아리 활동을 하고 있다.",
      "17. 나는 내가 깊이 관심을 가지고 있는 업체에 대한 여러 가지 정보(채용정보, 보수, 승진제도, 전망)를 수집하였거나 혹은 그 같은 계획을 세우고 있다.",
      "18. 나는 내가 설정한 취업을 달성하기 위해 수행한 일들을 항상 체크하고 있으며, 앞으로 할 일들에 대해서도 구체적으로 계획을 세우고 있다."
    ]
  };
            ...
            <div className="survey-container">
              ...
              <div className="expectation-intro">
                <p>
                  ...
                  자신이 가장 원하는 직업을 생각하면서 자신에게 해당되는 번호에 체크 하시기 바랍니다.
                </p>
              </div>
              ...
              <div className="expectation-questions">
                {[
                  ...
                  "선택한 직업이 자신에게 자신이 원하는 장점을 어느 정도나 충족시켜 주리라고 생각하십니까?",
                  "선택한 직업이 자신에게 가장 원하는 것을 가지게 해줄 가능성은 어느 정도라고 생각하십니까?"
                ].map((question, index) => (
            ...
            <div className="survey-container">
              ...
              <div className="career-efficacy-intro">
                <p>
                  ...
                  얼마나 자신감을 느끼는지에 대한 질문입니다. 각 문항에 대해 본인이 느끼는 자신감 정도에 따라 체크하여 주시기 바랍니다.
                </p>
              </div>
